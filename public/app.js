const dados = [
    {
        ...
        detalhes: "A República Horizonte oferece quartos individuais mobiliados, cozinha compartilhada, internet de alta velocidade e área de lazer. Ideal para estudantes da UFMG, com transporte público a 2 minutos de distância."
    },
    {
        id: 2,
        ...
        detalhes: "A República Minas Boa possui 5 quartos, 3 banheiros, área externa com churrasqueira e lavanderia. Próxima a bares, supermercados e transporte público."
    },
    {
        id: 3,
        ...
        detalhes: "República moderna com quartos individuais, cozinha equipada e áreas de convivência. Próxima a faculdades particulares e pontos de ônibus."
    }
]

if (document.getElementById("lista-republicas")) {
...
if (document.getElementById("detalhe-republica")) {
  const params = new URLSearchParams(window.location.search);
  const id = parseInt(params.get("id"));
  const republica = dados.find(r => r.id === id);
  
  if (republica) {
    document.getElementById("detalhe-republica").innerHTML = `
      <div class="card mb-4">
